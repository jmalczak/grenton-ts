// Created from: src/interfaces/module_gsm_fv07_0.xml, object name="GSM"
...
interface IGsm {
    ...
    ask: (telphone: string, question: string, timeout: number) => boolean
    /** Łączy z podanym numerem. Zwraca:\n1 - gdy nawiąże połączenie,\n0 - gdy nie ma połączenia */
...
class Gsm implements IGsm {
    ...
    ask(telphone: string, question: string, timeout: number): boolean { return this.raw.execute(MethodType.Ask, telphone, question, timeout) === 1; }
