...
interface IModbusClient {
     ...
     */
    setRefreshInterval: (refreshPeriod: number) => void
    /**
...
class ModbusClient implements IModbusClient {
     ...
     */
    setSocketAddress(socketAddress: string): void {
        this.raw.set(PropertyType.SocketAddress, socketAddress);
    }
    /**
     * Ustawia adres urządzenia Modbus
     * @param {number} deviceAddress
...
export { ModbusClient, ModbusClientRaw, ModbusClientRemote, RegisterTypeType, AlwaysWriteMultipleType, DataTypeType, DataWidthType, EndiannessType, InitialValueAccessType }
