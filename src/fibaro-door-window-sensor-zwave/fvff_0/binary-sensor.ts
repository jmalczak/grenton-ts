// Created from: src/interfaces/module_fibaro_door_window_sensor_ff.xml, object name="BINARY_SENSOR"
...
class BinarySensorRemote implements IBinarySensor {
...
export { BinarySensor, BinarySensorRaw, BinarySensorRemote }
