// Created from: src/interfaces/module_fibaro_rgbw_0.xml, object name="ZWAVE_RGBW_LED"
...
interface IZwaveRgbwLed {
    ...
    /** Zdarzenie wywoływane przy zmianie stanu ściemniacza na wyłączony (wartość większa niż MinValue) */
