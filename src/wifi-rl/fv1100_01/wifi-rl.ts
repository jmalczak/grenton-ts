// Created from: src/interfaces/clu_WIFI_RL_ft00000001_fv0000044c_ht00000023_hv00000001.xml, object name="CLU_WIFI_RL"
...
class CluWifiRl implements ICluWifiRl {
    private onInitCallbacks: Array<() => void> = [];

    constructor(private raw: CluWifiRlRaw) {
...
class CluWifiRlRemote implements ICluWifiRl {
...
export { CluWifiRl, CluWifiRlRaw, CluWifiRlRemote, TimeZoneType }
