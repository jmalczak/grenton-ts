// Created from: src/interfaces/clu_WIFI_SP_ft00000001_fv0000044c_ht00000021_hv00000001.xml, object name="CLU_WIFI_SP"
...
class CluWifiSp implements ICluWifiSp {
    private onInitCallbacks: Array<() => void> = [];

    constructor(private raw: CluWifiSpRaw) {
...
class CluWifiSpRemote implements ICluWifiSp {
...
export { CluWifiSp, CluWifiSpRaw, CluWifiSpRemote, TimeZoneType }
