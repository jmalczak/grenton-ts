...
interface ISatelOutput {
    ...
    switchOff: () => void
    /**
     * Ustawia parametr definiujący, do którego wyjścia odnosi się obiekt
     * @param {number} nr
     */
    setNr: (nr: number) => void
    /**
     * Ustawia hasło użytkownika, dla '_' zastosuje hasło administratora
     * @param {string} password
     */
    setUserPassword: (password: string) => void
    /** Zwraca stan wyjścia:1 - wyjście załączone,0 - wyjście wyłączone,-1 - stan wyjścia nieznany (brak połączenia  z centralką) */
...
class SatelOutput implements ISatelOutput {
     ...
     */
    setUserPassword(password: string): void {
        this.raw.set(PropertyType.UserPassword, password);
    }
    /**
     * Zwraca stan wyjścia:1 - wyjście załączone,0 - wyjście wyłączone,-1 - stan wyjścia nieznany (brak połączenia  z centralką)
     * @returns {ValueType}
...
export { SatelOutput, SatelOutputRaw, SatelOutputRemote, ValueType }
